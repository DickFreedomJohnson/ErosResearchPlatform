...
var/global/list/underwear_m = list(
	...
	"Boxers Heart" = "m7", "Boxers Black" = "m8", "Boxers Grey" = "m9", "Boxers Stripe" = "m10", "Diaper" = "m11", "None") //Curse whoever made male/female underwear diffrent colours
var/global/list/underwear_f = list(
	"Red" = "f1", "White" = "f2", "Yellow" = "f3", "Blue" = "f4", "Black" = "f5", "Thong" = "f6",
	"Black Sports" = "f7","White Sports" = "f8", "Black Sports Alt" = "f9", "White Sports Alt" = "f10", "Baby Blue" = "f11", "Green" = "f12", "Pink" = "f13", "Chainmail" = "f14", "Diaper" = "f15", "None")
	//undershirt
var/global/list/undershirt_t = list(
	...
	"Blue striped shirt" = "shirt_stripes_s", "Blue sport shirt" = "blueshirtsport_s", "Bra, Red" = "b1", "Bra, White" = "b2", "Bra, Yellow" = "b3", "Bra, Blue" = "b4", "Bra, Black" = "b5", "Bra, Half cup " = "b6",
	"Bra, Black Sports" = "b7","Bra, White Sports" = "b8", "Bra, Black Sports Alt" = "b9", "Bra, White Sports Alt" = "b10", "Bra, Baby Blue" = "b11", "Bra, Green" = "b12", "Bra, Pink" = "b13", "Bra, Chainmail" = "b14", "None")
	//Socks
var/global/list/socks_t = list(
	...
	"Thin thigh" = "thin_thigh", "Pantyhose" = "pantyhose", "Torn pantyhose" = "torn_pantyhose", "Striped thigh" = "striped_thigh",
