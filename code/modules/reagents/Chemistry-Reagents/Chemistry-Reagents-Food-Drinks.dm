...
/datum/reagent/ethanol/beer/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/curacoglass/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/coffee/kahlua/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/acidspit/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/bloodymary/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/dristmartini/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/irish_cream/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/longislandicedtea/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/manlydorf/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/whiskeysoda/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)
...
/datum/reagent/ethanol/drspank
	name = "Dr. Spank"
	id = "drspank"
	description = "Reserved for the most agressive drinkers."
	color = "#664300"
	strength = 10

	glass_icon_state = "drspank"
	glass_name = "glass of Dr. Spank"
	glass_desc = "Reserved for the most agressive drinkers."
	glass_center_of_mass = list("x"=16, "y"=9)

/datum/reagent/ethanol/drspank/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	M.add_chemical_effect(CE_PAINKILLER, 25)

/datum/reagent/ethanol/bitchjuice
	name = "Bitch Juice"
	id = "bitchjuice"
	description = "The highest class of frilly drinks. Nobody would question your manhood after this."
	color = "#664300"
	strength = 100

	glass_icon_state = "bitchjuice"
	glass_name = "glass of Bitch Juice"
	glass_desc = "The highest class of frilly drinks. Nobody would /dare/ question your manhood after this."
	glass_center_of_mass = list("x"=16, "y"=12)

/datum/reagent/ethanol/bitchjuice/affect_blood(var/mob/living/carbon/M, var/alien, var/removed)
	if(alien == IS_DIONA)
		return
	if(prob(4))
		M.apply_effect(3, STUTTER)
		M.make_jittery(5)
		M.emote(pick("drool", "moan", "giggle", "orgasm" ,"lipbite" , "pant" , "squirm" , "drool" , "whimper" , "shiver" , "blush"))